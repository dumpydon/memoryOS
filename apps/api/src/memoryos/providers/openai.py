...
class OpenAIProvider:
    ...
    def extract_candidates(self, *, text: str) -> list[CandidateMemory]:
        ...
        system = (
            ...
            "meaning and qualifiers of the source. Reuse a stable attribute key for "
            "the same proposition when possible; for example, use explanation_length "
            "for concise or short explanations rather than inventing a new key for "
            "each wording variation. "
    ...
    def assess_relations(
        ...
        *,
        ...
        system = (
            ...
            "attribute_key before comparing proposition meaning. Attribute keys may "
